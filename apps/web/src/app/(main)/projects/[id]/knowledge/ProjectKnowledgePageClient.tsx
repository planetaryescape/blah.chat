...
export default function ProjectKnowledgePage({
  ...
  const onDrop = useCallback(
    ...
    [projectId, refreshProjectKnowledge, requestJson, userId],
  );
      ...
      switch (addType) {
        case "text":
          ...
          await requestJson("/api/v1/knowledge/sources", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ type: "text", title, content, projectId }),
          });
          break;
        ...
        case "web":
          ...
          await requestJson("/api/v1/knowledge/sources", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ type: "web", url, title, projectId }),
          });
          break;
        ...
        case "youtube":
          ...
          await requestJson("/api/v1/knowledge/sources", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ type: "youtube", url, title, projectId }),
          });
          break;
  ...
  const handleDelete = async () => {
    ...
    try {
      await requestJson(
        `/api/v1/knowledge/sources/${encodeURIComponent(sourceToDelete._id)}`,
        {
          method: "DELETE",
        },
      );
