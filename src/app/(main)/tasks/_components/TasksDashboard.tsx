...
export function TasksDashboard() {
  ...
  const [projectFilter, setProjectFilter] = useState<Id<"projects"> | null>(null);
  ...
  }, [view, tasksAll, tasksToday, tasksUpcoming, tasksCompleted, tasksImportant, projectFilter]);

  // Special case: If projectFilter is set, we might want to fetch project name to display as Title
  // @ts-ignore
  const project = useQuery(api.projects.get, projectFilter ? { id: projectFilter } : "skip");
